...
const COLORS = [
  '#7c6af7', '#4a9eff', '#36d399', '#f59e42',
  '#f06292', '#26c6da', '#aed651', '#ff7043',
];
    ...
    <div style={{
      ...
      <div style={{
        ...
        {segments.map((seg, i) => {
          ...
          const isActive = currentFrame >= seg.start_frame && currentFrame <= seg.end_frame;
          return (
            <div
              key={seg.index}
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                border: 'none',
                background: isActive ? COLORS[i % COLORS.length] : 'var(--color-background-secondary)',
                color: isActive ? '#fff' : 'var(--color-text-secondary)',
                fontSize: 12,
                cursor: 'pointer',
                transition: 'all 0.15s',
                fontWeight: isActive ? 500 : 400,
                outline: isActive ? `2px solid ${COLORS[i % COLORS.length]}` : 'none',
                outlineOffset: 1,
              }}
            >
