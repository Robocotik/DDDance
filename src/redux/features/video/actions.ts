...
export const uploadVideo = (file: File) => async (dispatch: Dispatch<VideoAction>) => {
  ...
  try {
    ...
    const response = await axios.post<UploadVideoResult>("http://localhost:5458/api/users/load", formData, {
