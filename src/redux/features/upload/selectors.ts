...
// Новые селекторы для прогресс-бара и попапа
...
export const selectModerationFailed = (state: RootState) => state.upload.moderationFailed;
export const selectModerationReason = (state: RootState) =>
	state.upload.moderationReason;
export const selectCompareResult = (state: RootState) => state.upload.compareResult;
export const selectUploadDanceResult = (state: RootState) => state.upload.uploadResult;
